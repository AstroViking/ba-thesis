...
He was also able to show that his FFT based computation was able to outperform previous implementations (even Scikit-learn's tree based approach) in terms of runtime for a given accuracy by a factor of at least one order of magnitude, making KDEpy the de-facto standard of Kernel Density Estimation in Python.
