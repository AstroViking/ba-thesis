...
```{python, distDisplay, echo = FALSE, fig.cap="Distribution used to benchmark", cache=TRUE}
...
figure, axes = runner.plot_distributions(distributions, [-10, 10], 2)
plt.show()"""
```
...
```{python, compareRuntimesBasic, echo = FALSE, fig.cap=""}
#knitr::include_graphics('../plots/compare...')
```

```{r, compareRuntimeTable, echo=FALSE, eval=TRUE}
#knitr::kable(py$runtimes, booktabs = TRUE, caption = 'Comparing additional methods')
```
