...
Looking only at the evaluation runtimes of the newly proposed methods (figure \@ref(fig:compareZfitRuntimePDFwithoutKDEpy)), we can see that the performance differences are minimimal and the binned method shows good performance, even if its evaluation runtime increases faster with larger datasets compared to the other implementations.
